...
public class Activity_Search_2 extends BaseActivity {
    public static void startActivity(BeanSearch_2 beanSearch_2_){
        beanSearch_2=beanSearch_2_;
        Context context=MyApp.getContext();
        Intent intent=new Intent(context,Activity_Search_2.class);
        context.startActivity(intent);
    }

    private static BeanSearch_2 beanSearch_2;
    @BindView(R.id.rv_search_1)RecyclerView recyclerView;
    Adapter_Search_2 adapter_search_2;
