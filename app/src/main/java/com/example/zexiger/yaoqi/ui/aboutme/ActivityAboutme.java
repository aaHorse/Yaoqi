...
public class ActivityAboutme
        extends BaseActivity<PresenterAboutMe> implements ContractAboutMe.View {
    public static void startActivity(Context context){
        Intent intent=new Intent(context,ActivityAboutme.class);
    ...
    @OnClick(R.id.line_aboutme_2)void func_2(){
        ...
        intent.setClass(ActivityAboutme.this, ActivityQQ.class);
