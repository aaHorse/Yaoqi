...
public class Adapter_Load_1
    ...
    public Adapter_Load_1(List<BeanSpecific.DataBean.ReturnDataBean.ChapterListBean> lists){
        super(lists);
        addItemType(BeanSpecific.DataBean.ReturnDataBean.ChapterListBean.TYPE_1,R.layout.item_load_1);
    }
